...
const fetchAddBasketGood = () => {
  return fetch(`${rqURL}/basketgoods`).then((res) => {
    return res.json()
  }).then((data) => {
    return data
  })
...
const rqURL = "http://localhost:8000";
...
onload = () => {
  ...
  Vue.component('search', {
    props: ['search', 'filter'],
    template: `
        <input type="text" id='searchInput' class="cart-input" v-on:input="$emit('filter')">                 
    `
  });
  ...
  Vue.component('search-button', {
    props: ['search', 'filter'],
    template: `
    <button class="head-search" v-on:click='$emit("filter")'><svg class="search-svg" width="27" height="28"
  ...
  Vue.component('overlay', {
    props: ['item'],
    template: `
    <button class="overlay" @click="addGood"><svg class="overlay-svg" width="27" height="25" viewBox="0 0 27 25"
  ...
  Vue.component('goods-item', {
    ...
    <div class="goods-item">
               ...
               <div class="product-overlay">
                  <overlay v-bind:item='item'></overlay>
               </div>
  ...
  Vue.component('basket-item', {
    ...
    <img v-bind:src='item.image' alt="featureitem">
               ...
               <p class="feature-item-p1">Known for her sculptural takes on traditional tailoring, Australian
                  ...
                  teams up with Moda Operandi.</p>
               <p class="feature-item-p2">$\{{ item.price }}</p> 
               <p class="feature-item-p2">Количество:  {{ item.count }}</p>               
            </div>
    `
  });
